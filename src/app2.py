    ...
    if path != "/page2":
        ...
        if s0 is None or strikec is None or strikep is None or rate is None or sigmac is None or sigmap is None:
            ...
            def greek(S,grecque):
                ...
                theta_p = -(S * norm.pdf(d1_p) * sigmap) / (2 * np.sqrt(P.T)) - P.r * P.K * np.exp(-P.r * P.T) * norm.cdf(d2_c)
    ...
    if path != "/page2":
        ...
        if s0 is None or strikec is None or strikep is None or rate is None or sigmac is None or sigmap is None:
            ...
            def greek(K,grecque):
                ...
                theta_p = -(P.S0 * norm.pdf(d1_p) * sigmap) / (2 * np.sqrt(P.T)) - P.r * P.K * np.exp(-P.r * P.T) * norm.cdf(d2_c)
    ...
    if path != "/page2":
        ...
        if s0 is None or strikec is None or strikep is None or rate is None or sigmac is None or sigmap is None:
            ...
            def greek(K,grecque):
                ...
                theta_p = -(P.S0 * norm.pdf(d1_p) * sigmap) / (2 * np.sqrt(P.T)) - P.r * K * np.exp(-P.r * P.T) * norm.cdf(d2_c)
